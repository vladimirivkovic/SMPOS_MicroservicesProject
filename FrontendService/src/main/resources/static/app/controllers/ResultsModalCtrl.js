(function(angular) {
	angular.module('app.ResultsModalCtrl', []).controller(
			'ResultsModalCtrl',
			[ '$scope', '$uibModalInstance', 'a', 'readOnly',
					function($scope, $uibModalInstance, a, readOnly) {
						...
						$scope.today = function() {
							$scope.a.datumRealizacije = new Date();
						};
						

						$scope.clear = function() {
							$scope.a.datumRealizacije = null;
						};
						...
						$scope.setDate = function(year, month, day) {
							$scope.a.datumRealizacije = new Date(year, month, day);
						};
						...
						if (!$scope.a.datumRealizacije) $scope.today();
					} ]);
}(angular));